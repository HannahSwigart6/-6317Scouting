Imports System.IO
Public Class Form1
    'This export multiple rows of data into the txt file
    Dim a As StreamReader
    Dim b As String
    Dim c As String = "C:\User\hs131455\Desktop\Github repository\Scouting.txt"
    ...
    Private Sub btnResult_Click(sender As Object, e As EventArgs) Handles btnResult.Click
        ...
        'If no check boxes are checked.(original equation)
        ...
        '(If Rotor40, 80, 120, 160 is checked)
        ...
        'If one of the 4 rotor check boxes + the rope is checked = total
    ...
    Private Sub btnExcel_Click(sender As Object, e As EventArgs) Handles btnExcel.Click
        ...
        Else
            ...
            lblResult.Text = ""
            MsgBox("Information saved!", MsgBoxStyle.Information, "Saved")
        End If
    End Sub

    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'Storage File for Notepad information
    ...
    Private Sub ReadFile()
        ' Saved Information from other teams
